...
class Plugin {
	...
	public function css($path_to_file) {
		return '<link rel="stylesheet" href="'.$this->p_dir.'/'.$path_to_file.'" type="text/css" media="screen" charset="utf-8" />
';
	}
...
';
	...
	public function js($path_to_file) {
		return '<script src="'.$this->p_dir.'/'.$path_to_file.'" type="text/javascript" charset="utf-8"></script>
';
	}
