...
function slider(sliderName, settings){
	...
	// Add Nav Buttons
	$(sliderName).append('<div class="sliderNav"><a href="#" id="prev"><img src="plugins/slider/img/prev.png"></a><p class="sliderTitle">'+config.title+'</p><a href="#" id="next"><img src="plugins/slider/img/next.png"></a></div><!-- END .sliderNav -->');
