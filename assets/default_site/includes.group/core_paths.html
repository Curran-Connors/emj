...
//defined('SITE_ROOT') ? null : define('SITE_ROOT', 'http://localhost:8888/{LOCAL-PATH-GOES-HERE}/');

// REMOTE SITE ROOT PATH
defined('SITE_ROOT') ? null : define('SITE_ROOT', 'http://stage2.curran-connors.com/emj/emj-dev/');
