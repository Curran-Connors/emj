...
/*$element.children().hide();
			...
			function resizeOpenSlide() {
             ...
             $(window).resize(function () {
                 ...
                 if (($opts.initially_open_slide == 0) && (opened == 0)) {
                     ...
                     resizeTimer=setTimeout(resizeOpenSlide, 500);
                 }				 
             });
         ...
         OpenSlide: function (slide,controls) {
             ...
             if (slide != 0) {
				 ...
				 // emj metals addition by nick (fade color images in/out)
				 //----------------------------------------------------------------------------------	
				 	$element.children(this).find(".slide-image.color").fadeIn();
					$element.children(this).find(".slideshow-content").fadeOut();
				 	$element.children(this).eq(slide - 1).find(".slide-image.color").fadeOut();
				 	$element.children(this).eq(slide - 1).find(".slideshow-content").fadeIn();
				//----------------------------------------------------------------------------------	
